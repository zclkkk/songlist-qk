<script lang="ts">
  ...
  const bilibili = $derived(catalog.streamer.platforms.find((p) => p.label === 'Bilibili'));
</script>
...
<section class="hero-card">
  ...
  <div class="relative flex flex-col items-center px-6 py-12 text-center lg:px-12 lg:py-16">
    ...
    {#if bilibili}
      <a href={bilibili.href} target="_blank" rel="noreferrer" class="button button-primary button-lg mt-10">
